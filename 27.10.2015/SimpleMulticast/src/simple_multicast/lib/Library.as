...
package simple_multicast.lib {
	...
	public class Library {
		...
		[Embed(source="../../../res/images/enter.png")]public static const im0_PNG:Class;
		public static var im0:BitmapData;
		
		[Embed(source="../../../res/images/enter.png")]public static const enter_png:Class;
		public static var im_enter_png:BitmapData;
		[Embed(source="../../../res/images/list.png")]public static const list_png:Class;
		public static var im_list_png:BitmapData;
		...
		private static function createBitmaps():void {
			im_enter_png = new enter_png().bitmapData;
			im_list_png = new list_png().bitmapData;
