	...
	public class VCMScreen extends AVCM {
		...
		public override function listen(eventType:String, details:IAM):void {
			...
			case ID_A_DISPLAY_SCREEN_SCORE_BOARD:
				...
				vc.get_screenScreenStats().setText(
					gs.getPlayerById(randomWinner4UIDemo).get_id() == DUBoardMark.PLAYER_ID_YOU
					,4
		...
		private function el_screenStartNewGame(target:AVC, eventType:String, details:Object = null):void {
			...
			//case VCScreenStartNewGame.ID_E_B_ACTION:
				switch (details) {
				case VCScreenStartNewGame.ID_E_B_START:
					e.listen(ID_E_GAME_START, null);
					break;
		...
		public static const ID_E_GAME_START:String = NAME + '>ID_E_GAME_START';
