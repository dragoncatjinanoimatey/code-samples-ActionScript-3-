...
package t_t.v {
	...
	public class VCScreenStats extends AVC {
		...
		private function addSomeInterface():void {
			...
			var ab0:VCSimpleButton = new VCSimpleButton(0, el_actionButtons, APP.lText().get_TEXT(Text.ID_TEXT_STATS_BACK));
		...
		public function setText(userWon:Boolean, numMarks:int):void {
